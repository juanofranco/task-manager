...
function AddListenerController(view) {
  function ListenerController() {
    ...
    var imageItem = document.getElementById('fileField');
    var imageContent = document.getElementById('imageContent');
    var descriptionItem = document.getElementById('descriptionField');
    var addItem = document.getElementById('addButton');
    var itemList = document.getElementById('itemList');
    var updateItem = document.getElementById('updateButton');

    this.imageSelected = function (e) {
      e.preventDefault();
      var formData = imageItem.files[0];
      console.log(formData);
      var validateImage = new _utils.ImageValidation(formData);
      if (validateImage.validateType()) {
        var img = new Image();
        img.onload = function () {
          var imgWidth = this.width.toFixed(0);
          var imgHeight = this.height.toFixed(0);
          if (validateImage.validateDimensions(imgWidth, imgHeight)) {
            (0, _utils.printImage)(formData);
          } else {
    ...
    this.fileUpdate = function (e) {
      ...
      if (descriptionItem.value == '') {
        ...
        var imgInItem = $('#imageContent').find('img').attr('src');
        var img = imgInItem.replace('/uploads/', '');
    ...
    this.saveData = function (fileSaved, _oldId) {
      var oldId = _oldId;
      var filePath = fileSaved;
      var description = descriptionItem.value;
      var data = {
      ...
      fetch(oldId ? '/update/' + oldId : '/save', {
        ...
        if (oldId) {
          (0, _utils.removeItemInDom)(oldId);
          (0, _utils.showItemInDom)();
        }
        (0, _utils.printItemInDom)(response);
        (0, _utils.resetForm)();
      }).catch(function (err) {
    ...
    this.removeData = function (node) {
      ...
      fetch('/remove', {
        ...
        console.log(response);
        (0, _utils.removeItemInDom)(nodeId);
      }).catch(function (err) {
        return console.log(err);
      });
    };
    ...
    this.editData = function (nodeId) {
      idObject = nodeId;
      (0, _utils.editElement)(nodeId);
      (0, _utils.hiddeItemInDom)(nodeId);
    };

    this.inputMaxLength = function () {
      var max = descriptionItem.attributes.maxLength.value;
    ...
    this.listen = function () {
      imageItem.addEventListener('click', _utils.resetImage);

      imageItem.addEventListener('change', function (e) {
        this.imageSelected(e);
      }.bind(this), false);

      descriptionItem.addEventListener('keypress', function (e) {
      ...
      $('#itemList').on('click', '.itemRemove', function (e) {
        e.preventDefault();
        this.removeData(e.currentTarget.parentNode.parentNode.getAttribute('id'));
      }.bind(this));

      $('#itemList').on('click', '.itemEdit', function (e) {
        e.preventDefault();
        this.editData(e.currentTarget.parentNode.parentNode.getAttribute('id'));
      }.bind(this));

      $('.inputUpdate').on('click', '.cancelBtn', function (e) {
        e.preventDefault();
        (0, _utils.resetForm)();
        (0, _utils.showItemInDom)();
      }.bind(this));
...
var formChanges = AddListenerController(window);
formChanges.listen();
...
},{"./controller.js":329,"./utils.js":331,"babel-polyfill":1}],331:[function(require,module,exports){
'use strict';
...
var printImage = exports.printImage = function printImage(fileData) {
  var imgToShow = fileData;
...
var printItemInDom = exports.printItemInDom = function printItemInDom(response) {
  var itemLi = document.createElement('li');
  itemLi.setAttribute('id', response._id);
  var titemDv = document.createElement('div');
...
var removeItemInDom = exports.removeItemInDom = function removeItemInDom(_id) {
  var itemLi = document.getElementById(_id);
  itemList.removeChild(itemLi);
};
var hiddeItemInDom = exports.hiddeItemInDom = function hiddeItemInDom(_id) {
  $('.list').find('li').removeClass('hidde');
  var hidde = document.getElementById(_id);
  hidde.classList.add('hidde');
  var hiddeBtn = document.getElementById('inputSubmit');
  hiddeBtn.classList.add('hidde');
  $('form').find('.inputUpdate').removeClass('hidde');
};

var editElement = exports.editElement = function editElement(_id) {
  resetForm();
  var nodeId = _id;
  var _Id = '#' + nodeId;
  var textInSpan = $(_Id).find('span').text();
  var imgInItem = $(_Id).find('img').attr('src');
  var imgPath = imgInItem.replace('/uploads/', '');
...
var showItemInDom = exports.showItemInDom = function showItemInDom(_id) {
  $('.list').find('li').removeClass('hidde');
  $('form').find('.inputSubmit').removeClass('hidde');
  var hiddeBtn = document.getElementById('inputUpdate');
  hiddeBtn.classList.add('hidde');
};

var resetForm = exports.resetForm = function resetForm() {
  var img = document.getElementById('removeMe');
  if (img) {
...
var resetImage = exports.resetImage = function resetImage() {
  var img = document.getElementById('removeMe');
  if (img) {
    imageContent.removeChild(img);
  }
...
var ItemList = exports.ItemList = function () {
  function ItemList(_id) {
...
var ImageValidation = exports.ImageValidation = function () {
  ...
  _createClass(ImageValidation, [{
    ...
    value: function validateDimensions(imgWidth, imgHeight) {
